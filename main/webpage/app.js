...
/**
 * Get the DHT22 sensor temperature and humidity value for display on the web page
 */
 ...
 */
function stopWiFiConnectSatusInterval()
{
...
/**
 * Checks credentils on connect_wifi button click
 */
...
/**
 * Disconnets the Wifi once the disconnect button is pressed and reaload the web page
 */
...
/**
 * Sets the interval for displaying the local time once SNTP is synchronized
 */
...
/**
 * Gets the local time from the ESP32 and displays it on the web page
 * @note This requires WiFi connection and SNTP synchronization to work
 */
...
/**
 * Gets the connected SSID from the ESP32 and displays it on the web page
 */
function getSSID()
{
